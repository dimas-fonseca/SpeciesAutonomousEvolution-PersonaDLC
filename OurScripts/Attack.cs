...
public class Attack : MonoBehaviour
{
    ...
    public void AttackClick()
    {
        ...
        else if (!lockAttack)
        {
            ...
            int damageDealt = 5 + 5 * activeCreature.GetComponent<SpeciesAttributes>().attackUpgrade - 5 * passiveCreature.GetComponent<EnemiesAttributes>().deffenseUpgrade - passiveCreature.GetComponent<EnemiesAttributes>().persona.Defense;
            if(damageDealt < 0)
            {
                damageDealt = 0;
            }
